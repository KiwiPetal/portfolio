  ...
  return (
    <ReactLenis root>
      <div className="main">
        <ParallaxItem>
          <div className={styles.title}>
            <Image
              ...
              onClick={() => window.open("https://www.instagram.com/kiwi.petals/")}
              width={selfieWidth}
        ...
        <footer>
          <h2>This website is written with <a className="link" href="https://nextjs.org/">Next.JS</a> and is completely open-source.</h2>
          <h2>Feel free to fork and use it: <a className="link" href="https://github.com/KiwiPetal/portfolio">Repository</a></h2>
        </footer>
        </div>
      </div>
    </ReactLenis>
